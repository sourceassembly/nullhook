...
class TestInstTable(unittest.TestCase):
	...
	def test_wait(self):
		...
		IB32("9b90").check_mnemonic("WAIT", 0)
		IB32("9bdfe0").check_mnemonic("FSTSW")
		IB32("dfe0").check_mnemonic("FNSTSW")
		IB32("9b00c0").check_mnemonic("WAIT")
		IB32("9bd930").check_mnemonic("FSTENV")
		IB32("9b66dbe3").check_mnemonic("WAIT")
	def test_3dnow(self):
	...
	def test_vex(self):
		I32("vaddpd ymm1, ymm2, ymm2").check_mnemonic("VADDPD")
		I32("vaddps ymm1, ymm2, ymm2").check_mnemonic("VADDPS")
		I32("vaddsd xmm1, xmm2, qword [eax]").check_mnemonic("VADDSD")
		I32("vaddss xmm1, xmm2, dword [eax]").check_mnemonic("VADDSS")
		I32("vmovsd xmm1, xmm2, xmm3").check_mnemonic("VMOVSD")
		I32("vmovsd xmm1, qword [eax]").check_mnemonic("VMOVSD")

		IB32("c4e279dbc2").check_mnemonic("VAESIMC")
		IB32("c4e17938dbc2").check_mnemonic("VAESIMC")
		IB32("c5f938dbc2").check_mnemonic("VAESIMC")

		IB32("c4e3710dc255").check_mnemonic("VBLENDPD")
		IB32("c4e1713a0dc255").check_mnemonic("VBLENDPD")
	...
	def test_vex_special(self):
		...
		IB32("c4e2791800").check_mnemonic("VBROADCASTSS")
		IB32("c4e279ff00").check_invalid()
		IB32("c4e179ff00").check_invalid()
		IB32("c4e379ff00").check_invalid()
		IB32("c4e4791800").check_invalid()
		IB32("c5f8ae10").check_mnemonic("VLDMXCSR")
		IB32("c4c178ae10").check_mnemonic("VLDMXCSR")
		IB32("c4c179ae10").check_invalid()
		IB32("c4c17aae10").check_invalid()
		IB32("c4c17bae10").check_invalid()
		IB32("c4c17877").check_mnemonic("VZEROUPPER")
		IB32("c4c17c77").check_mnemonic("VZEROALL")
		IB32("c4c97c77").check_invalid()
	def test_crc32(self):
...
class TestMisc(unittest.TestCase):
	...
	def test_vexl_needed(self):
		...
		IB32("c4e36918cc42").check_invalid()
		IB64("c4e36918cc42").check_invalid()
...
class TestPrefixes(unittest.TestCase):
	...
	def test_stos(self):
		...
		self.assertEqual(str(IB16("2eab").inst), "STOSW")
		...
		self.assertEqual(str(IB32("2eab").inst), "STOSD")
		...
		self.assertEqual(str(IB64("2eab").inst), "STOSD")
		self.assertEqual(str(IB64("2e48ab").inst), "STOSQ")
	...
	def test_scas(self):
		...
		self.assertEqual(str(IB16("2eaf").inst), "SCASW")
		...
		self.assertEqual(str(IB32("2eaf").inst), "SCASD")
		...
		self.assertEqual(str(IB64("2eaf").inst), "SCASD")
		self.assertEqual(str(IB64("2e48af").inst), "SCASQ")
	...
	def test_movs(self):
		...
		self.assertEqual(str(IB64("4fa5").inst), "MOVSQ")
	...
	def test_cmps(self):
		...
		self.assertEqual(str(IB64("4fa7").inst), "CMPSQ")
...
class TestAPI(unittest.TestCase):
	...
	def test_drop_skip(self):
		s, count, results = self.direct_decompose(b"\x05\x00\x01", 0, distorm3.Decode32Bits, 0, 1)
		self.assertEqual(s, distorm3.DECRES_MEMORYERR)
		self.assertEqual(count, 1)
